...
<style type="text/css">
    ...
    <form action="" class="log-in" autocomplete="off" runat="server"> 
      <h4>Nhà hàng <span>Nam Sơn</span></h4>
      <p>Chào mừng đến với website quản lý nhà hàng Nam Sơn! Mời bạn đăng nhập:</p>
      <div class="floating-label">
        <input id="txtTenDangNhap" name="txtTenDangNhap" type="text" />
